...
def build_merged_summary_csv(test_ids):
    ...
    fieldnames = [
        ...
        'request_throughput_avg_rps', 'data_throughput_received_KBps', 'data_throughput_sent_KBps',
    ...
    for phase_idx, test_id in enumerate(test_ids):
        ...
        phase_agg.append({
            ...
            'request_throughput_avg_rps':     _pf(results.get('throughput')),
            'data_throughput_received_KBps':  _pf(results.get('bandwidth_received')),
            'data_throughput_sent_KBps':      _pf(results.get('bandwidth_sent')),
    ...
    total_row = {
        ...
        'request_throughput_avg_rps':    _wavg('request_throughput_avg_rps'),
        'data_throughput_received_KBps': _wavg('data_throughput_received_KBps'),
        'data_throughput_sent_KBps':     _wavg('data_throughput_sent_KBps'),
